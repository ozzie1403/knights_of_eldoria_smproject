...
from src.backend.models.entities import DragonSkill

class Dragon:
    def __init__(self, name: str, position: Tuple[int, int], skill: DragonSkill, energy: float = 100.0):
        self.name = name
    ...
    def __repr__(self):
        return f"Dragon({self.name}, Position: {self.position}, Energy: {self.energy})" 